...
class ScheduleApiTest {
    ...
    class ScheduleApiQueriesTest {
        ...
        class GetAllTest {
            ...
            @DisplayName("Should return correct empty JSON array when admin request for all schedules")
            ...
            @Test
            @WithMockUser(roles = "ADMIN")
            @DisplayName("Should return correct JSON array when admin request for all schedules")
        ...
        class GetByIdTest {
            ...
            @DisplayName("Should return correct schedule when owner request for get by ID")
            ...
            @Test
            @WithMockUser(roles = "USER", username = "user")
            @DisplayName("Should throw EntityNotFoundException with correct body when owner request for schedule which not exist")
